...
This matrix maps each critical EIR image to applicable compliance standards, including FIPS 140-2/140-3, seccomp profiles, AppArmor profiles, and implementation status.
