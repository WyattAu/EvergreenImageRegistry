...
**Implemented In:** [REQUIREMENTS.md](.specs/00_requirements/requirements.md) Part II §2.1 (C001, C007)
...
**Resolution Documented:** [ADR-005](.adrs/ADR-005-military-compliance-framework.md)
**Implemented In:** [REQUIREMENTS.md](.specs/00_requirements/requirements.md) Part VIII §8.1 (Compliance Framework)
...
**Resolution Documented:** [ADR-005](.adrs/ADR-005-military-compliance-framework.md)
**Implemented In:** [REQUIREMENTS.md](.specs/00_requirements/requirements.md) Part I §1.1 (Preference Order), Part IV §4.2 (Size Limits)
...
**Implemented In:** [REQUIREMENTS.md](.specs/00_requirements/requirements.md) Part I §1.1, [ADR-007](.adrs/ADR-007-base-image-preference-order.md)
...
**Implemented In:** [REQUIREMENTS.md](.specs/00_requirements/requirements.md) Part III §3.1, [ADR-006](.adrs/ADR-006-observability-architecture.md)
...
**Implemented In:** [REQUIREMENTS.md](.specs/00_requirements/requirements.md) Part I §1.2 (Ban), Part II §2.1 (C003 note)
