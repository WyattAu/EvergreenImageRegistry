...
Use EIR FIPS scan results as evidence in your own FIPS assessment. The wolfi-fips base images from Chainguard have
undergone more rigorous FIPS validation.
